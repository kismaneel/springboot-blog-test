package com.ddadak.springbootblog.config.jwt;
...
public class TokenProviderTest {
    ...
    void generateToken() {
        ...
        System.out.println("jwt issuer: " + jwtProperties.getIssuer());
        System.out.println("jwt secretKey: " + jwtProperties.getSecretKey());
